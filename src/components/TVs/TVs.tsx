...
import TVShowsSlider from "./TVSlider/TVShowsSlider";

function TVs({ tvShowsData }: any) {
    ...
    return (
        <Wrapper>
            <Banner bgPhoto={makePath(tvShowsData[0]?.data?.results[0].backdrop_path || tvShowsData[0]?.data?.results[0].poster_path)}>
