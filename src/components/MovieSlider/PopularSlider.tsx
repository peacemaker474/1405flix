...
import { InfoBox, InfoTitle, LeftButton, RightButton, SliderList, SliderTitle, SliderLists, SliderWrapper, ToggleBtn } from '../../styles/Slider/wrapper';
...
function PopularSlider({ movieData, offset, handleMoveDetail }: IPopularProps) {
    ...
    return (
        <SliderWrapper>
            <SliderTitle> 현재 인기가 많은 영화 </SliderTitle>
                        ...
                        movieData?.slice(index * offset, offset * index + offset).map(movie => (
                            ...
                            >
                                ...
                                <InfoBox variants={infoVariants}>
                                    ...
                                    <ToggleBtn onClick={handleMoveDetail(movie.id + "popular")}>
