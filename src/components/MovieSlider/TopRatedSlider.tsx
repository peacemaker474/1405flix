...
function TopRatedSlider({ movieData, offset, handleMoveDetail }: IPopularProps) {
    ...
    return (
        <SliderWrapper>
            <SliderTitle> 현재까지 인기가 많은 영화 </SliderTitle>
                        ...
                        movieData?.slice(index * offset, offset * index + offset).map(movie => (
                            ...
                            >
                                ...
                                <InfoBox variants={infoVariants}>
                                    ...
                                    <ToggleBtn onClick={handleMoveDetail(movie.id + "topRated")}>
